...
window.YEJI_CONFIG = {
  ...
  card: {
    ...
    message:
      "LOlldd! You thought it would be that easy?? Fweeeeakinnnell give bubu a kiss first!",
  },
  ...
  reasonsIntro: "Okay that was goof\n\nNow here's 10 reasons why you're the best",

  reasons: [
    {
      text: "You're soo goofy! It lightens my mood and brightens my day. It is what makes me look forward to coming home to you from work so that we can both be goofy together",
      photos: [
        "assets/photos/goofy.jpeg",
        "assets/photos/goofy pt 2.jpeg",
        "assets/photos/goofy pt 3.jpeg",
        "assets/photos/goofy pt 4.jpeg",
        "assets/photos/goofy pt 5.jpeg",
        "assets/photos/goofy pt 6.jpeg",
        "assets/photos/we like being goofy together.jpeg",
      ],
    },
    {
      text: "You're so beautiful. I'm not even kidding. You might not like that one photo but I think you look sooo naturally pretty. You're a natural beauty.",
      photos: [
        "assets/photos/you are a natural beauty.jpeg",
        "assets/photos/natural beauty.jpeg",
        "assets/photos/natural beauty pt 2.jpeg",
        "assets/photos/pretty pt 4.jpeg",
        "assets/photos/but damn you look good.jpeg",
        "assets/photos/look good pt 2.jpeg",
        "assets/photos/look good pt 3.jpeg",
      ],
    },
    {
      text: "You taught me how to pose candidly for the camera! Now all I have to do is walk towards you which I will doo happillyyyy",
      photos: [
        "assets/photos/you taught me how to take pose candidly.jpeg",
        "assets/photos/how to pose.jpeg",
        "assets/photos/how to pose pt 2.jpeg",
        "assets/photos/how to pose pt 3.jpeg",
        "assets/photos/how to pose pt 4.jpeg",
      ],
    },
    {
      text: "You introduced me to coke. I think it's unhealthy but I guess 0 calories is better than 100 and you're not drinking it as much!!",
      photos: [
        "assets/photos/you have some bad habits but they're 0 calories and you're not drinking as much!!.jpeg",
        "assets/photos/coke pt 2.jpeg",
      ],
    },
    {
      text: "You like cars. I kid you not it makes me soo happy that you like cars. The simple fact that you drive a Mini Cooper says that. It's not the brand. It's a woman driving that car. It gives old money vibes. Now next goal is Porsche. Slayyyyy",
      photos: [
        "assets/photos/you like cars.jpeg",
        "assets/photos/you like cars pt 2.jpeg",
      ],
    },
    {
    ...
    },
    {
      ...
      photos: [
        ...
        "assets/photos/no really you have a great fashion sense.jpeg",
      ],
    },
    {
      text: "And I learned from that fashion sense so both of us look ahgoofgoof now. I really like all these photos because you look sooo good and we look great in matching outfits!! I like :)",
      photos: [
        "assets/photos/matching couple.jpeg",
        "assets/photos/matching couple pt 2.jpeg",
        "assets/photos/stylish couple pt 2.jpeg",
        "assets/photos/stylish couple pt 3.jpeg",
        "assets/photos/stylish couple pt 4.jpeg",
        "assets/photos/stylish couple pt 5.jpeg",
        "assets/photos/stylish couple pt 6.jpeg",
        "assets/photos/stylish couple pt 7.jpeg",
        "assets/photos/we are such a good looking couple.jpeg",
      ],
    },
    {
    ...
    },
    {
      ...
      photos: [
        "assets/photos/you look so peaceful.jpeg",
        "assets/photos/nap pt 2.jpeg",
        "assets/photos/nap pt 3.jpeg",
        "assets/photos/nap pt 4.jpeg",
      ],
    },
  ],

  twist:
    "Lol it's your 26th birthday — you think that was all…? Fweaaaaakkkkkkinn! Here's 16 more geddit? Because 10 + 16 = 26 fweakinell",

  moreReasons: [
    {
      text: "I can be myself with you. I don't feel like I have to put on a facade. I can say whatever I want to because you don't make me feel like I'm walking on eggshells or that I have anything to hide and that's all because of you cutie",
      photos: [
        "assets/photos/i can be myself with you.jpeg",
        "assets/photos/be myself around you pt 2.jpeg",
        "assets/photos/be myself around you pt 3.jpeg",
      ],
    },
    {
      text: "You have great taste in food. You introduced me to pho and I love that. Getting EE-Sane with you is one of life's simple and satisfying pleasures but in this photo, we're not eating EE-Sane. It's Saigon Baguette",
      photos: [
        "assets/photos/you have good taste in food.jpeg",
        "assets/photos/food.jpeg",
      ],
    },
    {
      text: "You're such a day-dreamer and you like taking sooo many naps I don't have to worry about you getting bored. I also like that you feel comfortable enough to nap around me",
      photos: [
        "assets/photos/I dont have to worry about you because you're busy day dreaming.jpeg",
        "assets/photos/daydreaming.jpeg",
        "assets/photos/i like that you feel comfortable enough to nap around me.jpeg",
        "assets/photos/comfy around me.jpeg",
      ],
    },
    {
  ...
  quizIntro: "Now let's test some of your knowledge. Here's a short quiz for you",

  quiz: [
    {
      question: "Question 1 - What is boifweeennn's job title?",
      options: ["Data Scientist", "Software Engineer", "Machine Learning Engineer", "AI Engineer"],
      /** Index of the “correct” answer (0-based). Wrong answers still advance. */
      correctIndex: 3,
      correctReply: "Yettttuhhh you win a kiss from pookie!",
      wrongReply: "Close enough. I'll allow it. Give bubu a kiss and we can forget that you were wrong.",
    },
    {
    ...
    {
      question: "Question 5 - Who is the bestest person in the world?",
      options: ["Me", "myself", "I", "gurlllfween"],
      correctIndex: 0,
      correctReply: "Damn right it's you",
      wrongReply: "Damn right it's you",
    },
  ],

  finale: {
    message:
      "Happy birthday babygorl! Happy to have you in my life and happier to call you my gullfwennn",
    photo: "assets/photos/finale.jpeg",
  },
};
